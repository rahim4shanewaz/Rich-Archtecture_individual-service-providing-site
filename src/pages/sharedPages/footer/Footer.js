...
const Footer = () => {
    return (
     <div className='mt-10 mx-20'>
      <hr />
      <footer className="footer lg:flex justify-around p-10 bg-white text-black">
        
  <div>
  <div className='flex justify-center bg-white drop-shadow border'>
  ...
  <div>
    ...
    <div className="grid grid-flow-col gap-4">
      ...
      <small><p className='text-center'>Rich Architecture@copyRight-2022</p></small>
     </div>
    );
};
